...
# Parametere
SPEED = 100  # mm/s
TIME_TO_MOVE_SHORT = 10 / SPEED  # Tid for 10 mm bevegelse i sekunder
ROTATION_SPEED = 2  # Kommandoverdi til ESP32
...
def rotate_by_angle(esp, angle, current_pose):
    ...
    oppdaterer den interne pose og returnerer ny pose.
    """
